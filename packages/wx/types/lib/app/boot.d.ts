...
declare const WxApp_base: (abstract new (...rests: any[]) => {
    ...
    [x: string]: any;
    create(...rests: unknown[]): WxAppLibs & import("@catalyzed/asset").WxAssetsBundleOwner;
};
export declare class WxApp extends WxApp_base {
    static create(...rests: unknown[]): WxAppLibs & import("@catalyzed/asset").WxAssetsBundleOwner;
    constructor();
